...
<div class="page-header">
    <h1 style="margin:0"><i class="fas fa-plus" style="margin-left:8px"></i> إضافة فئة جديدة</h1>
</div>
...
<div class="card">
    <form action="{{ route('settings.categories.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control" placeholder="مثال: خواتم" value="{{ old('name') }}" required>
        </div>
